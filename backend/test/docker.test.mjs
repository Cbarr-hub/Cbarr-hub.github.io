...
test('buildConnectors builds every docker-backed entry, and skips when no client', () => {
  ...
  // A docker client → all seven (docker-backed) registry entries build, EACH wired
  ...
  for (const id of ['minecraft', 'factorio', 'counterstrike', 'gmod', 'prophunt', 'rlcraft', 'valheim']) {
