...
export const GOLDENS = [
  // ── GMOD (TTT) ────────────────────────────────────────────────────────────────
  {
    ...
    profileDefaults: {
      ...
      roundLimit: 6, timeLimit: 75, prepTime: 30, haste: 1, hasteStart: 5,
      postroundDm: 0, allTalk: 1,
    ...
    schemaGroups: [
      ...
      {
        key: 'gameplay',
        fieldKeys: ['maxPlayers', 'roundLimit', 'timeLimit', 'prepTime', 'haste', 'hasteStart',
          'postroundDm', 'allTalk', 'traitorPct', 'traitorMax', 'detectivePct', 'detectiveMax',
          'detMinPlayers', 'minPlayers', 'creditsStart', 'karma', 'karmaAutokick', 'karmaBan'],
        basicKeys: ['maxPlayers', 'roundLimit', 'prepTime', 'haste', 'traitorPct',
